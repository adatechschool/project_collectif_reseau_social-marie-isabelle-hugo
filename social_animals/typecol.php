...
<div class="bg-orange-100 h-screen w-48">
    ...
    <form method="post" action='<?php echo $actualPageUrl ?>'>
        ...
        <input type="submit" name="getPostsByType" value="See these animal's posts!" class="cursor-pointer hover:text-orange-600">
        </form>
        <form method="post" action='<?php echo $actualPageUrl ?>'>
            <input type="submit" name="resetChoices" value="Reset choices" class="cursor-pointer hover:text-orange-600">
        </form> 
    </aside>
</div>